...
const IdeaAnswerController = require('../controllers/ideaAnswerController');

module.exports = class IdeaAnswerRouter extends RouterBase{
    constructor(routePath, app, controller = null) {
        super(routePath, app, new IdeaAnswerController());
    }
